...
library(datapasta) # great for copy/pasta data into the R environment
library(biomaRt) # an alternative for anotation
...
# THIS DID NOT WORK FOR ME!! Specify the folder in which we can find the file?!

path<- file.path("kallisto_mappedReads", targets$sample,"abundance.tsv")
...
Tx <- as_tibble(Tx) #create a table - Tidy table = tibble
